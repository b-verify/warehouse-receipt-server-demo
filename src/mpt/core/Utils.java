...
public class Utils {
	...
	/**
	 * Get the bit at index in a byte array. byte array: byte[0]|| byte[1] ||
	 * byte[2] || byte[3] index [0...7] [8...15] [16...23] [24...31]
	 * 
	 * @param bytes
	 *            array of bytes representing a single value (byte[0]||byte[1]||..)
	 * @param index
	 ...
	 *            a byte
	 * @param index
	 *            index of the bit to get in [0, 7] (0-indexed)
	 * @return
	 */
	 ...
	 * 
	 * @param bytes
	 *            - bytes representing the "full path"
	 * @param endIdx
	 *            - an int such that prefix = bytes[:endIdx]
	 * @return
	 */
